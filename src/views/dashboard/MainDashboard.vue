 ...
 * @version: 
 * @Author: Lqi
 * @Date: 2021-12-31 15:01:04
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2022-01-20 16:34:42
-->
<template>
    ...
    <el-row :gutter="20">
      <el-col :span="18" :lg="18" :md="24" :sm="24" :xs="24">
        <CusCard>
          ...
          <div id="pvuv" ref="pvuv" style="width: 100%; height: 400px"></div>
        </CusCard>
      </el-col>
          ...
          <ul class="feedback-list">
            <li>
              ...
              <p class="feedback-info">
                <span>用户123</span><span>2021-04-07 13:15:45</span>
              </p>
            </li>
            <li>
              <p>用户觉得这次更新特别赞</p>
...
const initPVUV = () => {
  pvuvChart = echarts.init(document.getElementById("pvuv") as HTMLElement);
  pvuvChart.setOption({
    tooltip: {
      trigger: "axis",
    },
    ...
    series: [
      {
        ...
        stack: "总量",
        data: [
          120, 132, 101, 134, 90, 40, 31, 120, 132, 101, 134, 90, 230, 210, 120,
          132, 101, 134, 90, 230, 210, 266, 284, 246, 352,
        ],
      },
      {
        name: "UV",
        ...
        stack: "总量",
        data: [
          220, 182, 191, 166, 122, 102, 90, 111, 182, 191, 234, 290, 330, 310,
          220, 182, 191, 234, 290, 330, 310, 220, 235, 289, 236,
        ],
      },
    ],
  });
